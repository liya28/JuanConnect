...
class TCPDF {
	...
	public function writeHTML($html, $ln = true, $fill = false, $reseth = false, $cell = false, $align = '') {
		...
		$curfontstretching   = $this->font_stretching;
		...
		$this->premode       = false;
		if (!empty($this->inxob j) && $this->inxob j) {
			// inside an XObject template
			$pask = isset($this->xobjects[$this->xobjid]['annotations']) 
				? count($this->xobjects[$this->xobjid]['annotations']) 
				: 0;
		} elseif (!empty($this->PageAnnots[$this->page])) {
